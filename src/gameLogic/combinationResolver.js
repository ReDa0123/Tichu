import { equalsToOne, isNilOrEmpty } from "ramda-extension";
import { BOMBS, COMBINATIONS, SPECIAL_CARDS, VALUES } from "./constants";
import {
  add,
  all,
  anyPass,
...
export const isCombinationBomb4 = (playedCards) => {
  if (isCardInArray(SPECIAL_CARDS.PHOENIX, playedCards)) return false;
  const values = getCardValues(playedCards);
